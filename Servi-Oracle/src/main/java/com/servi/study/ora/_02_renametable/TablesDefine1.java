...
public class TablesDefine1 {
    public static void main(String[] args) {
        ...
        for (String t : stable) {
            ssctables.add(t.toUpperCase());
        }
        Set<String> sscneedtables = new HashSet<>();
        for (String t : TablesDefine1.sscneedtable.split(";")) {
            sscneedtables.add(t.toUpperCase());
        }

        System.out.println(IJsonUtil.toJson(ssctables));

        System.out.println("===========================");

        System.out.println(IJsonUtil.toJson(sscneedtables));
    }
