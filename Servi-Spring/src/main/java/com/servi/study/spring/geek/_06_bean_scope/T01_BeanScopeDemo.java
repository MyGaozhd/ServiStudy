package com.servi.study.spring.geek._06_bean_scope;
 ...
 * @since
 */
public class T01_BeanScopeDemo implements DisposableBean {
    ...
    public static void main(String[] args) {
        ...
        applicationContext.register(T01_BeanScopeDemo.class);
    ...
    private static void scopedBeansByInjection(AnnotationConfigApplicationContext applicationContext) {
        T01_BeanScopeDemo beanScopeDemo = applicationContext.getBean(T01_BeanScopeDemo.class);
