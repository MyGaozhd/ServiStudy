package com.servi.study.spring.geek._10_i18n;
 ...
 * @since
 */
public class T03_DynamicResourceMessageSource extends AbstractMessageSource implements ResourceLoaderAware {

    private static final String resourceFileName = "msg.properties";

    private static final String resourcePath = "i18n\\" + resourceFileName;
    ...
    public T03_DynamicResourceMessageSource() {
    ...
    public static void main(String[] args) throws InterruptedException {
        T03_DynamicResourceMessageSource messageSource = new T03_DynamicResourceMessageSource();
